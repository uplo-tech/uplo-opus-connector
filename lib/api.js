...
var s = __importStar(require("uplo.js"));
var uplojs_lib_1 = require("uplojs-lib");
...
var initClient = function (options) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        ...
        try {
            Uplo = new uplojs_lib_1.Client(uploClientConfig);
            return [2 /*return*/, {
                    apiInitialized: true,
    ...
    return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            if (cache_1.default.get(cacheKey)) {
                return [2 /*return*/, cache_1.default.get(cacheKey)];
            }
            res = {
            ...
            cache_1.default.set(cacheKey, res, NORMALIZE_RESOURCE_EXPIRE);
            t1 = performance.now();
