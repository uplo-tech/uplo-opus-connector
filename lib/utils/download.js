...
function promptToSaveBlob(_a) {
    var content = _a.content, name = _a.name, downloadUrl = _a.downloadUrl;
    if (downloadUrl) {
...
function triggerHiddenForm(_a) {
    var downloadUrl = _a.downloadUrl, _b = _a.target, target = _b === void 0 ? '_self' : _b;
    ...
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, new Promise(function (resolve, reject) {
                    ...
                    emitter_1.default.on('downloadpath', function (data) {
                    ...
                    emitter_1.default.emit('downloadrequestpath', filename);
                })];
        });
    });
}
