...
var notifications_1 = __importDefault(require("../utils/notifications"));
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, upload_1.readLocalFile(apiOptions.uploadType)];
                case 2:
                    paths = _a.sent();
                    return [3 /*break*/, 4];
                case 3:
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    onFail = function (err) { return emitter_1.default.emit('notification', err); };
                ...
                case 4:
                    _b.trys.push([4, 6, , 7]);
                    return [4 /*yield*/, api_1.default.uploadFileToId(uploPath, uploadPath)];
                case 5:
                    _b.sent();
                    return [3 /*break*/, 7];
                case 6:
                ...
                case 10:
                    ...
                    return [4 /*yield*/, api_1.default.uploadFileToId(uploPath, eachPath)];
                case 11:
                    _b.sent();
                    navigateToDir(resource.id, null, false, false);
                    return [3 /*break*/, 13];
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                getMessage = translations_1.default.bind(null, apiOptions.locale);
                return [4 /*yield*/, api_1.default.allUploads()
            ...
            case 1:
                ...
                if (itemsUploading > 5) {
                    ...
                    notification = notifications_1.default.getNotification(notifications, label);
                    ...
                    if (oldNotificationsExist.length > 0) {
                        newNotifications_1 = notifications_1.default.removeNotification(notifications, label);
                    ...
                    if (notificationExists.length > 0) {
                        ...
                        child = notifications_1.default.getChild(notification.children, notificationChildId_1);
                        ...
                        newChildren_1 = notifications_1.default.updateChild(notification.children, notificationChildId_1, newChild);
                        newNotifications_2 = notifications_1.default.updateNotification(notifications, label, {
                    ...
                    childElement = {
                        ...
                        elementProps: {
                            ...
                            path: '_multipleitems',
                            progress: 10,
                            icon: icons_1.getIcon({ title: 'archive.zip' })
                        }
                    };
                    notificationChildId = nanoid_1.default();
                    newChildren = notifications_1.default.addChild((notification && notification.children) || [], notificationChildId, childElement);
                    newNotification = {
                        title: getMessage('uploadingItems', { quantity: itemsUploading }),
                        children: newChildren
                    };
                    newNotifications = notification
                        ? notifications_1.default.updateNotification(notifications, label, newNotification)
                        : notifications_1.default.addNotification(notifications, label, newNotification);
                    ...
                    if (multiuploadExists.length > 0) {
                        newNotifications = notifications_1.default.removeNotification(notifications, label);
                    ...
                    ds.forEach(function (d) {
                        ...
                        var notification = notifications_1.default.getNotification(notifications, label);
                        ...
                        if (notificationExists.length > 0) {
                            ...
                            if (d.available) {
                                ...
                                if (notificationChildrenCount > 1) {
                                    var newChildren = notifications_1.default.removeChild(notification.children, notificationChildId);
                                    newNotifications = notifications_1.default.updateNotification(notifications, label, {
                                ...
                                var child = notifications_1.default.getChild(notification.children, notificationChildId);
                                ...
                                var newChildren = notifications_1.default.updateChild(notification.children, notificationChildId, newChild);
                                var newNotifications = notifications_1.default.updateNotification(notifications, label, {
                                    children: newChildren
                                });
                                return updateNotifications(newNotifications);
                            }
                            ...
                            var childElement = {
                                ...
                                elementProps: {
                                    ...
                                    path: d.uplopath,
                                    progress: progress,
                                    icon: icons_1.getIcon({ title: title })
                                }
                            };
                            var notificationChildId = nanoid_1.default();
                            var newChildren = notifications_1.default.addChild((notification && notification.children) || [], notificationChildId, childElement);
                            var newNotification = {
                                title: newChildren.length > 1
                                    ? getMessage('uploadingItems', { quantity: newChildren.length })
                                    : getMessage('uploadingItem'),
...
exports.uploadFile = function (apiOptions, actions) {
    var localeLabel = translations_1.default(apiOptions.locale, label, null);
    ...
    emitter_1.default.on('startuploadpoll', function () {
        console.log('polling uploads');
        hoistNotifications();
    });
    return {
        id: label,
        icon: { svg: icons_svg_1.default.fileUpload },
        label: localeLabel,
...
exports.uploadFolder = function (apiOptions, actions) {
    var localeLabel = 'Upload Folder';
    return {
        id: label,
        icon: { svg: icons_svg_1.default.folderUpload },
        label: localeLabel,
        shouldBeAvailable: function (apiOptions) { return true; },
        availableInContexts: ['files-view', 'new-button'],
