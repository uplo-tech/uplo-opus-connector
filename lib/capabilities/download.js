...
var uplo_utils_1 = require("../uplo-utils");
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, download_1.saveLocalFile(resources.length > 1 ? 'Multi Download Will Save With Original Filenames' : resources[0].title)];
                case 2:
                    downloadPath = _a.sent();
                    if (!(resources.length === 1)) return [3 /*break*/, 4];
                    res = resources[0];
                    params = uplo_utils_1.getDownloadParams(res);
                    p = api_1.default.cleanRootFromPath(params.uplopath);
                    return [4 /*yield*/, api_1.default.queueDownload(p, downloadPath)];
                case 3:
                    result = _a.sent();
                ...
                case 4:
                    ...
                    resources.forEach(function (r) { return __awaiter(_this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    params = uplo_utils_1.getDownloadParams(r);
...
var updateNotifications = function (apiOptions, actions) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                updateNotifications = actions.updateNotifications, getSelectedResources = actions.getSelectedResources, getNotifications = actions.getNotifications;
                return [4 /*yield*/, api_1.default.allDownloads()];
            case 1:
                ds = _a.sent();
                getMessage = translations_1.default.bind(null, apiOptions.locale);
...
exports.default = (function (apiOptions, actions) {
    ...
    emitter_1.default.on('startdownloadpoll', function () {
        console.log('polling downloads');
        hoistNotifications();
    });
    return {
        id: label,
        icon: { svg: icons_svg_1.default.fileDownload },
        label: localeLabel,
